...
* @replace_text => (true|false)@ - specifies to use the subtitles as anchor text instead of showing up as span's under the links
...
Maybe you want your anchor text to be something beside the named routes to have some freedom in your choice of route names (this can be handy in case of i18n). By setting the @:replace_text@ option to @true@, the subtitles will become the anchor text of the links instead.

<pre><code>navigation [:home, 'Start Here', :about, 'Learn More'], :replace_text => true</code></pre>
...
The generated link text is discarded in favor of your passed text.
